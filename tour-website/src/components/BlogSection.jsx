...
const BlogSection = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-slate-50 via-white to-slate-50 relative overflow-hidden">
      {/* Decorative Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 animate-slideInLeft bg-white">
            ...
            <div className="p-8">
              ...
              {/* Title */}
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6 leading-tight group-hover:text-primary transition-colors duration-300">
                {featuredPost.title}
              </h3>

              {/* CTA */}
              <div className="flex items-center justify-between">
                <button className="group/btn flex items-center gap-2 text-primary font-semibold hover:text-primary transition-colors duration-300">
                  View Post
                  <svg
            ...
            <div className="absolute top-6 right-6 w-16 h-16 border-t-4 border-r-4 border-white opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          </div>
          ...
          <div className="space-y-6 animate-slideInRight">
            {recentPosts.map((post, index) => (
              <div
                key={post.id}
                className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden flex gap-4 p-4 hover:-translate-y-1"
                style={{
                  animation: `slideInRight 0.6s ease-out ${index * 0.1 + 0.2}s both`,
                }}
              >
                {/* Thumbnail */}
                <div className="relative w-48 h-40 flex-shrink-0 overflow-hidden rounded-xl">
                  ...
                  {/* Date Badge */}
                  <div className="absolute top-3 left-3 bg-slate-700/90 backdrop-blur-sm text-white px-3 py-2 rounded-lg text-center text-xs font-semibold">
                ...
                <div className="flex-1 flex flex-col justify-between py-2">
                  ...
                  {/* Footer */}
                  <div className="flex items-center justify-between">
                    <button className="group/btn flex items-center gap-2 text-primary font-semibold hover:text-primary transition-colors duration-300 text-sm">
                      View Post
                      <svg
